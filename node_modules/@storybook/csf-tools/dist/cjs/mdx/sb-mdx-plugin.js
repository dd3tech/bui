...
var sanitizeName = function sanitizeName(name) {
  var key = (0, _camelCase.default)(name);
...
function genAttribute(key, element) {
  ...
  if (t.isJSXExpressionContainer(value)) {
    var _generate = (0, _generator.default)(value.expression, {}),
        code = _generate.code;
...
function genImportStory(ast, storyDef, storyName, context) {
  var _generate2 = (0, _generator.default)(storyDef.expression, {}),
...
function getBodyPart(bodyNode, context) {
  ...
  var _generate3 = (0, _generator.default)(body, {}),
      storyCode = _generate3.code;

  var _generate4 = (0, _generator.default)(sourceBody, {}),
...
function genStoryExport(ast, context) {
  ...
  if (!bodyNodes.length) {
    // plain text node
    var _generate5 = (0, _generator.default)(ast.children[0], {}),
  ...
  var source = (0, _jsStringEscape.default)(sourceCode);
  var sourceParam = "storySource: { source: '".concat(source, "' }");

  if (parameters) {
    var _generate6 = (0, _generator.default)(parameters, {}),
  ...
  if (decorators) {
    var _generate7 = (0, _generator.default)(decorators, {}),
  ...
  if (loaders) {
    var _generate8 = (0, _generator.default)(loaders, {}),
...
function genCanvasExports(ast, context) {
  ...
  for (var i = 0; i < ast.children.length; i += 1) {
    ...
    if (t.isJSXElement(child) && t.isJSXIdentifier(child.openingElement.name) && child.openingElement.name.name === 'Story') {
      ...
      var _generate9 = (0, _generator.default)(child, {}),
          code = _generate9.code; // @ts-ignore
  ...
  if (titleAttr) {
    if (t.isStringLiteral(titleAttr)) {
      ...
      try {
        ...
        var _generate10 = (0, _generator.default)(titleAttr.expression, {}),
...
function getExports(node, context, options) {
  ...
  if (type === 'jsx') {
    if (STORY_REGEX.exec(value)) {
      // Single story
      var ast = (0, _parser.parseExpression)(value, {
        plugins: ['jsx']
      });
      var storyExport = genStoryExport(ast, context);

      var _generate11 = (0, _generator.default)(ast, {}),
    ...
    if (CANVAS_REGEX.exec(value)) {
      ...
      var _ast = (0, _parser.parseExpression)(value, {
        plugins: ['jsx']
      });
      ...
      var _generate12 = (0, _generator.default)(_ast, {}),
    ...
    if (META_REGEX.exec(value)) {
      var _ast2 = (0, _parser.parseExpression)(value, {
        plugins: ['jsx']
      });
...
var getMdxSource = function getMdxSource(children) {
  return encodeURI(children.map(function (el) {
    return (0, _generator.default)(el).code;
  }).join('\n'));
...
var getNamedExports = function getNamedExports(node) {
  var namedExports = {};
  var ast = (0, _parser.parse)(node.value, {
    sourceType: 'module',
...
function extractExports(root, options) {
  ...
  root.children.forEach(function (child) {
    if (child.type === 'jsx') {
      try {
        var ast = (0, _parser.parseExpression)(child.value, {
          plugins: ['jsx']
        });
        ...
        var _generate13 = (0, _generator.default)(ast, {}),
  ...
  var defaultJsx = (0, _mdxHastToJsx.toJSX)(root, {}, Object.assign({}, options, {
    skipExport: true
  }));
