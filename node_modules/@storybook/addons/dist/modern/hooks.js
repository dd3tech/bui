...
export const applyHooks = applyDecorators => (getStory, decorators) => {
...
function triggerUpdate() {
  const hooks = getHooksContextOrNull(); // Rerun getStory if updates were triggered synchronously, force rerender otherwise
