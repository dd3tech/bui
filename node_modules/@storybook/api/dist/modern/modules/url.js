...
import { NAVIGATE_URL, STORY_ARGS_UPDATED, SET_CURRENT_STORY, GLOBALS_UPDATED } from '@storybook/core-events';
...
const initialUrlSupport = ({
  ...
  const _queryFromLocation = queryFromLocation(location),
    ...
    selectedStory // the rest gets passed to the iframe
        ...
        otherParams = _objectWithoutPropertiesLoose(_queryFromLocation, ["full", "panel", "nav", "shortcuts", "addonPanel", "addons", "panelRight", "stories", "selectedKind", "selectedStory", "path"]);
...
export const init = (_ref) => {
  let {
    ...
    fullAPI
      ...
      rest = _objectWithoutPropertiesLoose(_ref, ["store", "navigate", "state", "provider", "fullAPI"]);
