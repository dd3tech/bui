...
import { transformStoriesRawToStoriesHash } from '../lib/stories';
const {
  location,
  fetch
} = global;
    ...
    setRef: (id, _ref, ready = false) => {
      let {
        stories
          ...
          rest = _objectWithoutPropertiesLoose(_ref, ["stories"]);
      ...
      const after = stories ? addRefIds(transformStoriesRawToStoriesHash(map(stories, ref, {
        storyMapper
      }), {
        provider
      }), ref) : undefined;
