...
function drawBoxModel(element) {
  return function (context) {
    if (element && context) {
      ...
      labelStacks(context, dimensions, [].concat(_toConsumableArray(contentLabels), _toConsumableArray(paddingLabels), _toConsumableArray(borderLabels), _toConsumableArray(marginLabels)), externalLabels);
    }
  };
}
