...
var queryNavigate = function queryNavigate(to, options) {
  return typeof to === 'number' ? (0, _router.navigate)(to) : (0, _router.navigate)("".concat(getBase(), "path=").concat(to), options);
...
var QueryMatch = function QueryMatch(_ref4) {
  ...
  return /*#__PURE__*/_react.default.createElement(QueryLocation, null, function (_ref5) {
