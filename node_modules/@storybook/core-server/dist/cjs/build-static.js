...
async function buildStaticStandalone(options) {
  ...
  if (features !== null && features !== void 0 && features.buildStoriesJson) {
    var storiesGlobs = await presets.apply('stories');
    await (0, _storiesJson.extractStoriesJson)(_path.default.join(options.outputDir, 'stories.json'), storiesGlobs, options.configDir);
  }
