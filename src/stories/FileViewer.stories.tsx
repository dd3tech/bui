...
const Template: ComponentStory<typeof FileViewer> = ({ fileType, url, fileName, className }: any) => (
    <FileViewer className={className}>
        <FileViewer.ViewerActions fileName={fileName}>
            <FileViewer.BtnAction icon="DownloadIcon" onClick={() => console.log('Download clicked')} />
            <FileViewer.BtnAction icon="TrashIcon" onClick={() => console.log('Delete clicked')} />
            <FileViewer.BtnAction icon="ArrowsExpandIcon" onClick={() => console.log('Reload clicked')} />
