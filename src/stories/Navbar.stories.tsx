...
import { BellIcon, ClipboardCheckIcon, LockClosedIcon, UserAddIcon, UserCircleIcon } from '@heroicons/react/outline'
...
const Lendd3rLogo = () => (
    <figure className="block">
        <img style={{ height: 30 }} src="http://lendd3r-frontend-develop.s3-website-us-west-1.amazonaws.com/assets/lendder.53f51ab2.png" />
    </figure>
)

const Avatar = () => (
    <figure className="bg-gray-800 flex text-sm rounded-full w-12 h-12 overflow-hidden" style={{ width: 36, height: 36 }}>
        <img
