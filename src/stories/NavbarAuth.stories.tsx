...
import { NavbarAuth as NavbarApp } from '../components/Navbar'
import {
  LockClosedIcon,
  UserAddIcon,
  UserCircleIcon
...
const Template: ComponentStory<typeof NavbarApp> = (args) => (
  <NavbarApp {...args} />
)
...
const collapse = (
  <Collapse>
    <div className="border-b-2 p-2">
      ...
      <Anchor
        to="/project-list"
        className="mt-4 opacity-none rounded-lg flex gap-2 px-4 py-2 text-sm text-gray-600 hover:bg-gray-100"
      >
        <ClipboardCheckIcon className="text-gray-400" height={20} width={20} />{' '}
        Mis proyectos
      </Anchor>
      <Anchor
        to="/developer/new"
        className="flex opacity-none rounded-lg gap-2 px-4 py-2 text-sm text-gray-600 hover:bg-gray-100"
      >
    ...
    <div className="border-b-2 p-2">
      ...
      <Anchor
        ...
        className="flex opacity-none rounded-lg mt-4 gap-2 px-4 py-2 text-sm text-gray-600 hover:bg-gray-100"
      >
        <UserCircleIcon height={20} width={20} className="text-gray-400" />
        Mi perfil
      </Anchor>
      <span className="flex rounded-lg gap-2 px-4 py-2 text-sm text-gray-600 hover:bg-gray-100 cursor-pointer">
