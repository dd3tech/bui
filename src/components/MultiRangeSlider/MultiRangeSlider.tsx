...
export const updateBar = (
  ...
  const minPercent = getPercent(
    input.name === 'max-val' ? minMaxVal : Number(input.value),
    min,
    max
  )
  ...
  return (
    <div className={composeClasses('relative multi-slider', className)}>
      ...
      <input
        ...
        className={composeClasses(
          'thumb z-40 absolute pointer-events-none h-0 w-full outline-none',
          thumbMargin[sizeBar],
          size
        )}
      />
      ...
      <div className="relative w-full">
        <div
          className={composeClasses(
            'bar absolute w-full rounded bg-blue-100 z-10',
            barSizeVariants[sizeBar]
          )}
        />
        <div
          role="range-bar"
          ref={range}
          className={composeClasses(
            'absolute rounded bg-blue-800 z-20',
            barSizeVariants[sizeBar],
            sizeBar
          )}
