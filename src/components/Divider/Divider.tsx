...
export const getClassesDivider = ({ vertical, light, variant, size = 'small' }: Omit<IDivider, 'className'>) => {
    ...
    return {
        ...
        color: light ? 'border-gray-300 dark:border-blue-700' : 'border-gray-400 dark:border-blue-50'
    }
}
