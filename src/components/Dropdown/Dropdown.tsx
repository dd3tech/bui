...
interface DropdownProps extends React.HTMLAttributes<HTMLDivElement> {
    children: [ReactElement<typeof DropdownTrigger>, ReactElement<typeof DropdownMenu>]
...
type DropdownComponent<T, P = {}> = React.ForwardRefExoticComponent<PropsWithoutRef<P> & RefAttributes<T>> & {
