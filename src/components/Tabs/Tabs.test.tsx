...
describe('<TabGroup /> variant="primary ', () => {
  it('Indication bar is renderer: orientation="horizontal"', () => {
    ...
    expect(indicationBar.style.backgroundColor).toBe(
      defaultProps.indicatorColor
    )
  })
  ...
  it('<Tab /> was renderer: orientation="vertical"', () => {
    ...
    expect(result.getByRole('contentinfo').textContent).toEqual(
      defaultProps.disabledText
    )
  })
})
