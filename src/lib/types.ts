...
const twJustifyContentValues = ['start', 'end', 'center', 'between', 'around', 'evenly'] as const

export type JustifyContent = typeof twJustifyContentValues[number]

const twAlignItemsValues = ['start', 'end', 'center', 'baseline', 'stretch'] as const

export type AlignItems = typeof twAlignItemsValues[number]

const twTextAlignmentValues = ['left', 'center', 'right', 'justify', 'start', 'end'] as const

export type TextAlignment = typeof twTextAlignmentValues[number]

const sizeValues = ['xs', 'sm', 'base', 'lg', 'xl', '2xl', '3xl', '4xl'] as const
